...
# define PROMPT "\001\e[1;36m\002minishell\001\e[0m\002 \001\e[1;32m\002➜➜➜ \001\e[0m\002"
...
bool		set_pipe_fd(t_command *cmds, t_command *curr_cmd);
...
void		free_data_history(t_data *data);
